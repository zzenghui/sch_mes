...
<template>
  <div class="group card">
    <div class="operation">
      <el-input v-model="groupKey" style="width: 250px;" size="large" placeholder="请输入权限组名称">
        <template #append>
          <el-icon>
            <Search></Search>
          </el-icon>
      ...
      <el-button type="primary" icon="Plus">添加权限组</el-button>
    </div>
    <el-table :data="tableData" border>
      <el-table-column label="#" type="index" align="center"></el-table-column>
      <el-table-column label="权限组名称" prop="groupName" align="center"></el-table-column>
      <el-table-column label="权限组秒速" prop="desc" align="center"></el-table-column>
